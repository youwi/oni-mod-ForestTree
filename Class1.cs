...
namespace oni_ForestTree
{
    ...
    public class ForestTreeBranchConfigPatch
    {
        ...
        public static void Postfix(GameObject inst,GameObject __instance)
        {
            ...
            if (seedParent != null)
            {
                Console.WriteLine("树枝上级生成时：GetComponentInParent<MutantPlant>：" + seedParent.MutationIDs);
            }
            ...
            Console.WriteLine("ForestTreeBranchConfig树枝生成时：seed.MutationIDs：" + seed.MutationIDs);
    ...
    public class BuddingTrunkPatch
    {
        ...
        public static void Postfix(BuddingTrunk __instance)
        {
            ...
            Console.WriteLine("BuddingTrunk 测试信息：" + gameObject.MutationIDs);
        }
    }
    ...
    public class BTreeBudPatch
    {
        ...
        {
            var gameObject = __instance.GetComponentInParent<MutantPlant>();
            Console.WriteLine("BTreeBudPatch 测试信息：" + gameObject.MutationIDs);
        }
    }
}
